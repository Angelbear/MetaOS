                      ...
                      const RSAPublicKey *keys, int numKeys)
{
    ...
    ui_show_progress(
            0.4, //VERIFICATION_PROGRESS_FRACTION,
            45);//VERIFICATION_PROGRESS_TIME);
    ui_print("Skip verify...\n");
    if (false/*!verify_jar_signature(zip, keys, numKeys)*/) {
    ...
    register_package_root(NULL, NULL);  // Unregister package rootd
    return result;
}
