...
static int show_text = 1; //0; change default to show_text, by frank
...
static void *input_thread(void *cookie)
{
    ...
    for (;;) {
        ...
        do {
            ...
            if (touchscreen_test && ev.type==EV_ABS) {
...
int ui_menu_select(int sel) {
    ...
    if (show_menu > 0) {
        old_sel = menu_sel;
        menu_sel = sel;
#if 1 /* enable roll back by frank */
...
static void lcd_test_refresh(void)
{
